...
function render_posts($attributes, $content, $block) {
                ...
                <div class="fp-cp-categories">
                    ...
                    <?php foreach ( $terms as $term ) { ?>
                        ...
                        <a href="<?php echo get_term_link( $term ); ?>" class="fp-cp-categories-i">
                            ...
                            <img src="<?php echo get_field( 'featured_image', 'category_' . $term->term_id )['url']; ?>" alt="<?php echo esc_html($term->name); ?>">
