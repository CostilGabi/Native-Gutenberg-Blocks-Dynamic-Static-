...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"wpr/savours","title":"RK - Savours (Front Page)","category":"widgets","icon":"welcome-widgets-menus","description":"Savours part for Frontpage","keywords":["savours","custom","wpr","custopost"],"version":"1","textdomain":"wpr","editorScript":"file:./index.js","attributes":{"contentTitle":{"type":"string","default":""},"contentDescription":{"type":"string","default":""},"secondTitle":{"type":"string","default":""},"postdata":{"type":"object","default":[]}}}');
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/fp-pt-savours/block.json");
    ...
    async function fetchPostData() {
      try {
        const fetchedPostData = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_5___default()({
          path: '/maikurapi/v1/savours-data'
        });
        setAttributes({
