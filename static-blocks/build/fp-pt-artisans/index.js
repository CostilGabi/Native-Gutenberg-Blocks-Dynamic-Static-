...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"wpr/artisans","title":"RK - Artisans (Front Page)","category":"widgets","icon":"welcome-widgets-menus","description":"Artisans part for Frontpage","keywords":["artisans","custom","wpr","custopost"],"version":"1","textdomain":"wpr","editorScript":"file:./index.js","attributes":{"contentTitle":{"type":"string","default":""},"contentDescription":{"type":"string","default":""},"secondTitle":{"type":"string","default":""},"postdata":{"type":"object","default":[]}}}');
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/fp-pt-artisans/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  edit({
    ...
    async function fetchPostData() {
      try {
        const fetchedPostData = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_5___default()({
          path: '/maikurapi/v1/woocommerce-data'
        });
        setAttributes({
    ...
    }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, "Latest 4 Products are displayed on Front End"));
  },
  save({
    attributes
  }) {
    ...
    }, (postdata.categories || []).map((category, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    ...
    }, (postdata.products || []).map((product, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
